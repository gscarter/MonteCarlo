...
project = 'MonteCarlo'
copyright = ("2025, Gabrielle Carter. Project structure based on the "
             "Computational Molecular Science Python Cookiecutter version 1.10")
author = 'Gabrielle Carter'
...
texinfo_documents = [
    (master_doc, 'montecarlo', 'MonteCarlo Documentation',
     author, 'montecarlo', 'A python package for computing average ising ensemble values',
     'Miscellaneous'),
]
